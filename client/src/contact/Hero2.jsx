    ...
    <div className="px-4 lg:px-6 mt-[130px] lg:mt-[210px] w-full relative">
      <div className="mx-[9%]">
        ...
        <div className="mt-6 lg:flex lg:flex-row flex flex-col  gap-8 items-start max-w-full">
          {/* Form */}
          <form
            action="https://formsubmit.co/akhilrajuvysyaraju19@gmail.com"
            method="POST"
            target="dummyframe"
          ...
          >
            ...
            <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
              My inbox is always open. Whether you have a project or just want to say hi, I would love
              to hear from you. Feel free to contact me and I'll get back to you.
            </p>
            <div className="flex flex-row gap-4 mt-2">
              <div
                onMouseEnter={() => setHoveredIcon('linkedin')}
                onMouseLeave={() => setHoveredIcon(null)}
                className={`${iconStyle('linkedin')} cursor-pointer`}
              >
                <FaLinkedin size={24} />
              </div>
              <div
                ...
                onMouseLeave={() => setHoveredIcon(null)}
                className={`${iconStyle('github')} cursor-pointer`}
              >
                <FaGithub size={24} />
              </div>
              <div
                ...
                onMouseLeave={() => setHoveredIcon(null)}
                className={`${iconStyle('mail')} cursor-pointer`}
              >
                <Mail size={24} />
              </div>
            </div>
        ...
        <section className="mt-20 max-w-3xl mx-auto mb-20">
          <h2 className="text-4xl font-bold mb-8 text-center">Have Questions?</h2>
