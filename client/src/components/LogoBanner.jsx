...
const LogoBanner = ({isDark}) => {
  ...
  {
    id: 13,
    link: 'https://assets.streamlinehq.com/image/private/w_300,h_300,ar_1/f_auto/v1/icons/1/cloudinary-icon-ug0qqy8ms6ozyzy6cntbll.png/cloudinary-icon-hz05evx1htrghud89kpab4.png?_a=DATAdtXyZAA0',
    name: 'Cloudinary',
  },
  {
    id:14,
    link:'https://icon.icepanel.io/Technology/svg/Tailwind-CSS.svg',
    name:'TailwindCss'
  }
];
